			...
			<%
				...
				try {
					con = DriverManager.getConnection(
							"jdbc:oracle:thin:@127.0.0.1:1521:XE", "soldesk","1234");
				...
				try {
					...
					if (!(rs.next())) {
						...
						for (int j = startrow; j <= endrow; j++) {
							...
							downprice = nf.format(((Integer) dprice.elementAt(j))
									.intValue());
							
							String cat_id=(String)cat.elementAt(j);
							
							switch ( Integer.parseInt(cat_id.trim()) ){
								case 11:
									category = "가구";
									break;
								case 22:
							...
							out.print("<A href=\"product_read.jsp?id=" + id
									+ "&go=" + where);
							out.print("&cat=" + ca + "&pname=" + pn + "\">"
									+ pname.elementAt(j));
							out.println("</A></TD>");
