...
ORDER BY id ASC; 
 ...
 ----- ------ ----- -------- --------------- ------- -------- -------- --- --------------------- ---------- -----
 user1 1234   개발자1  123-1234 email1@mail.com 123-123 인천시      남동구      A01 2014-08-28 11:38:31.0 member.jpg    H
 user2 1234   개발자2  123-1234 email2@mail.com 123-123 광명시      남동구      A01 2014-08-28 11:39:19.0 member.jpg    H
...
5) 우편 번호 검색
 ...
 -----------------------------------
insert into zipcode values('110-260','서울','종로구','가회동',' ');
insert into zipcode values('110-170','서울','종로구','견지동',' ');
insert into zipcode values('110-310','서울','종로구','경운동',' ');
insert into zipcode values('110-776','서울','종로구','경운동 고합빌딩',' ');
insert into zipcode values('110-775','서울','종로구','경운동 수운회관',' ');
insert into zipcode values('110-708','서울','종로구','경운동 종로경찰서',' ');
insert into zipcode values('110-800','서울','종로구','계동','1∼100번지');
insert into zipcode values('110-801','서울','종로구','계동','101∼148');
insert into zipcode values('110-270','서울','종로구','계동',' ');
insert into zipcode values('110-793','서울','종로구','계동 현대빌딩',' ');
insert into zipcode values('110-160','서울','종로구','공평동',' ');
insert into zipcode values('110-702','서울','종로구','공평동 제일은행본점건물',' ');
insert into zipcode values('110-420','서울','종로구','관수동',' ');
insert into zipcode values('110-111','서울','종로구','관철동',' ');
 ---------------------------------
   SELECT zipcode, sido, gugun, dongli, etc 
   FROM zipcode 
   WHERE (dongli LIKE '%계동%') 
...
ORDER BY mdate DESC; 
 ...
 user2 1234   개발자2  123-1234 email2@mail.com 123-123 광명시                  남동구      A01 2014-09-02 11:52:45.0 member.jpg
 user1 1234   개발자1  123-1234 email1@mail.com 123-123 인천시                  남동구      A01 2014-09-02 11:52:31.0 member.jpg
...
'123-123','서울시','강남구' ,'A01', sysdate, 'member.jpg', 'A'); --grade A로 지정
